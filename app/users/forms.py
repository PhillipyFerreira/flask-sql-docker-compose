...
MensagemErro = "Passwords must match." #crianção de constante 
...
class PasswordForm(FlaskForm):
    ...
    confirm = PasswordField(
        ...
        validators=[
            DataRequired(),
            EqualTo('password', message=MensagemErro) #aplicação de constante 
        ]
    )
...
class SettingsForm(FlaskForm):
    ...
    confirm = PasswordField(
        ...
        validators=[
            EqualTo('new_password', message=MensagemErro) #aplicação de constante 
        ]
    )
    recaptcha = RecaptchaField()
