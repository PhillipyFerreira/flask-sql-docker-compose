...
PASSWORD_MUST_MATCH_MESSAGE = u'Passwords must match.'
...
class PasswordForm(FlaskForm):
    ...
    confirm = PasswordField(
        ...
        validators=[
            DataRequired(),
            EqualTo('password', message=PASSWORD_MUST_MATCH_MESSAGE)
        ]
    )
...
class SettingsForm(FlaskForm):
    ...
    confirm = PasswordField(
        ...
        validators=[
            EqualTo('new_password', message=PASSWORD_MUST_MATCH_MESSAGE)
        ]
    )
    recaptcha = RecaptchaField()
